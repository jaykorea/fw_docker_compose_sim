...
--tab --title="slam" -e "zsh -c \"source /home/fw05/.zshrc;sleep 5s;roslaunch fw_rev_04_rtabmap fw_mapping_stereo_test2_jay_2dlidar.launch rviz:=false database_path:=~/.ros/zen.db;exec zsh\"" \
--tab --title="nav" -e "zsh -c \"source /home/fw05/.zshrc;sleep 5s;roslaunch fw_rev_04_navigation fw_move_base_teb.launch;exec zsh\""
